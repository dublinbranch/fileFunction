...
[[deprecated("why you want hex and short ?")]] QByteArray shortMd5(const QByteArray& string);
[[deprecated("why you want hex and short ?")]] QByteArray shortMd5(const QString& string);
